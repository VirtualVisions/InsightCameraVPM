...
namespace Vowgan
{
    ...
    {
        [Header("Controls")] [Tooltip("Input used for toggling the entire camera system.")] [SerializeField]
        private KeyCode InputActiveToggle = KeyCode.T;

        [Tooltip("Input used for moving the camera behind the player.")] [SerializeField]
        private KeyCode InputPrimaryView = KeyCode.Alpha1;

        [Tooltip("Input used for moving the camera over the left shoulder.")] [SerializeField]
        private KeyCode InputLeftShoulderView = KeyCode.Alpha2;

        [Tooltip("Input used for moving the camera over the right shoulder.")] [SerializeField]
        private KeyCode InputRightShoulderView = KeyCode.Alpha3;

        [Tooltip("Input used for moving the camera to face backwards towards the player.")] [SerializeField]
        private KeyCode InputPrimaryRear = KeyCode.Alpha4;

        [Tooltip("Input used for toggling the camera between the front or back view.")] [SerializeField]
        private KeyCode InputForwardViewToggle = KeyCode.F;

        [Tooltip("Input used for toggling the camera between the right or left right shoulder view.")] [SerializeField]
        private KeyCode InputShoulderViewToggle = KeyCode.Q;

        [Tooltip("Input used for toggling the visibility of the controls.")] [SerializeField]
        private KeyCode InputControlsToggle = KeyCode.Tab;

        [Tooltip("Input used for toggling camera tracking.")] [SerializeField]
        private KeyCode InputRoamingToggle = KeyCode.G;

        [Tooltip("Input used for toggling camera smoothing.")] [SerializeField]
        private KeyCode InputBlending = KeyCode.B;

        [Header("Field of View")] [Tooltip("Input used for toggling the Fov zoom.")] [SerializeField]
        private KeyCode InputFovToggle = KeyCode.Mouse2;

        [SerializeField] private float FovZoomIn = 30;
        [SerializeField] private float FovZoomOut = 60;

        [Header("Audio")] [SerializeField] private AudioSource Source;
        ...
        {
            if (Input.GetKeyDown(InputActiveToggle)) _ToggleCamera();
